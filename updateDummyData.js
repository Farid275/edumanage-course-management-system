...
export const attendance = [
  ...
  { id: 4, time: "09:00 - 10:30", title: "Database Systems (CS301)", location: "Room 402, Building A", isLecturer: true, active: false },
  { id: 5, time: "11:00 - 12:30", title: "Software Engineering (CS305)", location: "Lecture Hall B", isLecturer: true, active: false }
];
...
export const reports = [
  // Keeping this empty for now since there are no hardcoded reports in the components we saw, but it can be used later.
];
`;
