...
import { assignmentsData as initialAssignments, courses as dummyCourses, lecturers as dummyLecturers } from '../data/dummyData';
...
const AssignmentsManagement = () => {
  ...
  const [dateFilter, setDateFilter] = useState(''); // New filter for due date
  ...
  const handleOpenModal = (assignment = null) => {
    if (assignment) {
      ...
      setFormData({
        ...
        lecturer: dummyLecturers.length > 0 ? dummyLecturers[0].name : '',
        due_date: '',
        submissions: 0,
        status: 'Draft'
      });
            ...
            <form onSubmit={handleSave} className="p-6 flex flex-col gap-4 max-h-[80vh] overflow-y-auto">
              ...
              <div className="flex gap-4">
                ...
                >
                  ...
                  {dummyLecturers.map(l => <option key={l.id} value={l.name}>{l.name}</option>)}
                </SelectField>
              </div>
